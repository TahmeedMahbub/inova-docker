    ...
    $.fn.imageUploader = function (options) {
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                {
                    $uploadedContainer.append(createImg('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWlmjtZSzb1aHKqgv5nzYHYrVJIHcmBVWpAw&usqp=CAU', dataTransfer.items.length - 1, file.name))
                }
                else
                {  
