    ...
    function cb(m) {
        if (!db) {
            ...
            if (m.creditHref && m.creditText) {
                m._creditLink || (m._creditLink = document.createElement("a"), m._creditLink.setAttribute("class", "canvasjs-chart-credit"), m._creditLink.setAttribute("title", ""), m._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" +
                ...
                if (0 === m.renderCount || s || q) m._creditLink.setAttribute("href", ""), m._creditLink.innerHTML = "";
