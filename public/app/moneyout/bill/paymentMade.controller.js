...
function PaymentMadeController($scope, $http) {
    ...
    $http
        ...
        .then(function(response){
            ...
            //         dataTextField: 'Name',
            //         dataValueField: 'value',
            //         template: "#=text # #=first_name # #=last_name #",
            //         filter: "contains",
            //         autoBind: true,
            //         minLength: 3,
            //         dataSource: 
            ...
            //                         dataItem.Name   = dataItem.text + "  " + dataItem.first_name + " " + dataItem.last_name;
            //                     }
    ...
    $scope.calculateExcessPayment = function (index) {
        ...
        for(var i = 0; i < $scope.bills.length; i++)
        {
            ...
            {
                UIkit.notify({
                    message: 'Amount cannot be greater than ' + $scope.bills[i].due_amount,
                    status: 'danger',
                    timeout: 2000,
                    pos: 'top-right'
                });
            ...
            {
                UIkit.notify({
                    message: 'Amount cannot be greater than ' + $scope.amount,
                    status: 'danger',
                    timeout: 2000,
                    pos: 'top-right'
                });
            ...
            $scope.used_amount = total_balance;
