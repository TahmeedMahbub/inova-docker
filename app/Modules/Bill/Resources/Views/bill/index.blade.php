                                    ...
                                    <div class="uk-modal-dialog">
                                        ...
                                        <div class="uk-width-large-2-2 uk-width-2-2">
                                            @if(session('branch_id')==1)                                            
                                                <div class="uk-width-large-2-2 uk-width-2-2 uk-margin-small-bottom">
                                            ...
                                            <div class="uk-width-large-2-2 uk-width-2-2">
                                                <div class="uk-input-group">
                                                    ...
                                                    <label for="from_date_id">From</label>
                                                    <input value="{{ isset($from_date)?$from_date:date('Y-m-d') }}" required class="md-input" type="text" id="from_date_id" name="from_date" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                                </div>
                                            </div>
                                            <div class="uk-width-large-2-2 uk-width-2-2 uk-margin-small-top">
                                                <div class="uk-input-group">
                                                    <span class="uk-input-group-addon"><i class="uk-input-group-icon uk-icon-calendar"></i></span>
                                                    <label for="to_date_id">To</label>
                                                    <input value="{{ isset($to_date)?$to_date:date('Y-m-d') }}" required class="md-input" type="text" id="to_date_id" name="to_date" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                                </div>
                                            </div>
                                            <div class="uk-width-large-2-2 uk-width-2-2 uk-margin-small-top">
                                                <div class="uk-input-group">
                                            ...
                                            <div class="uk-width-large-2-2 uk-width-2-2 uk-margin-small-top">
                                                <div class="uk-input-group">
                                                    ...
                                                    {{-- <label for="uk_dp_1">Vendors</label> --}}
                                                    <select data-uk-tooltip="{pos:'top'}" class="md-input select2-single-search-dropdown"
                                                         name="vendor_id">
                                                        <option value="">Select Vendor</option>
                                                        @foreach($vendors as $vendor)
                                                            <option value="{{ $vendor->id }}" {{ isset($selected_vendor_id) && $vendor->id == $selected_vendor_id ? 'selected' : '' }}>{{ $vendor->display_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
