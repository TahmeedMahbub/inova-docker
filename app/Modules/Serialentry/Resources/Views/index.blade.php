                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['url' => 'serialentry', 'method' => 'GET', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                                        <div class="uk-modal-header">
                                            <h3 class="uk-modal-title"><i class="material-icons" data-uk-tooltip="{pos:'top'}" title="headline tooltip">&#xE8FD;</i></h3>
                                        </div>

                                        <div class="uk-width-large-2-2 uk-width-2-2">
                                          
                                                <div class="uk-width-medium-2-2">
                                                     <label for="uk_dp_1">Bill No.</label>
                                                    <input value="" class="md-input" type="text"  name="bill_no" >
                                                    <br/>
                                                </div>
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Serial List</span></h2>
                            </div>
                        </div>
                                      ...
                                      @foreach($bills as $key=>$bill)
                                        <tr>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">                                               
                                                <a href="{{url('serialentry/edit/'.$bill->id)}}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
...
@section('scripts')
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            var id = $(this).next('.stock_serial_id').val();
            swal({
                title: 'Are you sure?',
                ...
                window.location.href = "serialentry/delete/"+id;
            })
        })
