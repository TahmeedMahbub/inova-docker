                                    ...
                                    @foreach($payment_mades as $payment_made)
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                @if ($payment_made->cheque_status == 'unpresented')
                                                    <a href="{{ route('cheque_drawn', ['id' => $payment_made->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Cheque Drawn" class="md-icon material-icons">check</i></a>
                                                @endif
