                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['url' => 'recurring-invoices', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Recurring Invoice List</span>
                                <div style="float: right;margin-top:-29px;padding:0px" >
                                     <form action="{{route('recurring_invoices_index')}}" method="get">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div  class="uk-width-medium-1-2">
                                          <input  value="" required class="form-control" type="text" placeholder="Invoice No."  name="invoice_no" >
                                        </div>
                                        <div  class="uk-width-medium-1-2">
                                          <button type="submit" name="submit" class="md-btn md-btn-success md-btn-flat-default" style="margin-left: -20px;"> Submit </button>
                                        </div>
                                    </div>
                        ...
                        <div class="user_content">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($recurring_invoices as $invoice)
                                        <tr>
                                            ...
                                            <td>INV-{{ str_pad($invoice->recurring_invoice_number, 6, '0', STR_PAD_LEFT) }}</td>
                                            ...
                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                <a href="{{ route('recurring_invoices_show', ['id' => $invoice->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="View" class="material-icons">visibility</i></a>
                                                <a href="{{ route('recurring_invoices_edit',['id'=>$invoice->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('recurring_invoices_create') }}" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "/recurring-invoices/delete/"+id;
            })
        })
