...
<div class="uk-modal" id="modal_header_footer" ng-controller="UseCreditController">
    <div style="padding: 8px !important" class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Use credits for INV-{{ str_pad($invoice->invoice_number, 6, '0', STR_PAD_LEFT) }}</h3>Invoice Balance : BDT {{ $invoice->total_amount}}
        </div>
                ...
                <div class="uk-grid uk-margin-large-top uk-margin-large-bottom" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1">
                        <table class="uk-table">
                            <thead>
                            <tr>
                                <th class="uk-text-nowrap">Credit Number#</th>
                            ...
                            <tr ng-repeat="use_credit in use_credits track by $index" class="form_section" id="data_clone">
                                <td>
                                    <label>@{{ use_credit.credit_note_number }}</label>
