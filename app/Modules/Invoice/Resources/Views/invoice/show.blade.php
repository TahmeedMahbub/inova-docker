                                    ...
                                    <table id="table_center" border="1" style="width: 100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center"> {{$invoice_entry->unit_id?$invoice_entry->quantity/$invoice_entry->basic_unit_conversion.''.$invoice_entry->unit->name:$invoice_entry->quantity }} </td>
