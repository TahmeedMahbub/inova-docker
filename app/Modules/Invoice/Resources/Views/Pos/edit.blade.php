...
@section('content')
    <div class="uk-grid">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('point_of_sales_update',['id'=>$invoice->id]), 'method' => 'POST', 'class' => 'user_edit_form ', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                                  ...
                                  <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-4">
                                          <label  for="invoice_number">Invoice Number</label>
                                            <input type="text" class="md-input" id="invoice_number" name="invoice_number" value="{{ str_pad($invoice->invoice_number, 6, '0', STR_PAD_LEFT) }}" disabled />
                                        </div>
                                       <div class="uk-width-medium-1-4">
                                    ...
                                    <div  class="uk-grid uk-margin-large-top" data-uk-grid-margin>
                                        <div style="margin-top:-100px" class="uk-width-medium-1-1">
                                                           ...
                                                           <div  class="container">
                                                            <div class="row">
                                                              ...
                                                              <div  style="padding:13px 10px 13px 10px" class="col-md-12 col-sm-12 col-xs-12">
                                                                <select id="item_id_{{$key}}" class="md-input select2-single-search-dropdown" name="item_id[]" onchange="getItemPrice(<?php echo $key; ?>)" required>
                                                                  <option value="">select Product/Service </option>
                                                                  @foreach($product as $value)
                                                                    <option {{ $invoice_entry_value->item_id == $value->id ? 'selected' : '' }} value="{{ $value->id }}"> {{ $value->item_name}} </option>
                                                                    @endforeach
                                                               </select>
                                                              </div>
                                                            </div>
                                                            <div class="row">
                                                              ...
                                                              <div  class="col-md-10 col-sm-8 col-xs-8">
                                                                <input  type="text" id="serial_<?php echo $key; ?>" name="serial[]" class="md-input serial" value="{{ $invoice_entry_value->serial }}" />
                                                              </div>
                                                            </div>
                                                            <div class="row">
                                                              <div class="col-md-2 col-sm-4 col-xs-4">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <div  class="col-md-10 col-sm-8 col-xs-8">
                                                                <input type="text" id="rate_{{$key}}" name="rate[]" class="md-input rate" value="{{ $invoice_entry_value->rate }}" oninput="calculateActualAmount(<?php echo $key; ?>)" required readonly/>
                                                              </div>
                                                            </div>
                                                            <div class="row">
                                                              <div class="col-md-2 col-sm-4 col-xs-4">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <select class="md-input discount_type"  id="discount_type_{{$key}}" name="discount_type[]" onchange="calculateActualAmount(<?php echo $key; ?>)" class="md-input itemId select2-single-search-dropdown">
                                                                  <option {{ $invoice_entry_value->discount_type ==1 ?'selected' : '' }}  value="1" selected>BDT</option>
                                                                  <option {{ $invoice_entry_value->discount_type ==0 ?'selected' : '' }}>%</option>
                                                              </select>
                                                              </div>
                                                            </div>
                                                            <div class="row">
                                                              ...
                                                              <div  class="col-md-10 col-sm-8 col-xs-8">
                                                               ...
                                                               <div  class="">
                                                                 <div  class="uk-accordion" data-uk-accordion>
                                                                   <a href="#" style="margin-left:0px" class="remove_field btn btn-danger" data-val="`+x+`"> Delete</a>
                                                                 </div>
                                                               </div>
                                                               <br>
                                                          </div>
                                          ...
                                          <div style="display:;float:right;margin-top:5px !important " class="add_table">
                                                        ...
                                                        <div style="padding-top: 10px;padding-bottom: 10px" class="md-card">
                                                          <div style="width:97% ; margin:1px" class="container">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
                                                                 <input type="text" style="margin-top :-25px" id="adjustment" name="adjustment" class="md-input md-input-width-medium" value="{{$invoice->adjustment}}" oninput="calculateActualAmount(0)"/>
                                                              </div>
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
                                                            ...
                                                            <br>
                                                            <div class="row">
                                                              <div class="col-md-4 col-sm- col-xs-2">
                                                                  Vat(%)
                                                              </div>
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
                                                                  <input type="text" style="margin-top :-25px" id="vat" class="md-input md-input-width-medium" value="{{ $tax }}" oninput="calculateActualAmount(0)" />
                                                              </div>
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
                                                                <input style="margin-top :-25px" type="text" id="shippingCharge" name="shipping_charge" class="md-input md-input-width-medium"  value="{{ $invoice->shipping_charge }}" oninput="calculateActualAmount(0)"/>
                                                              </div>
                                                              <div class="col-md-4 col-sm-4 col-xs-5">
            ...
            if(x < max_fields)
            {
                ...
                $('.getMultipleRow').append(`<tr class="tr_`+x+`" >`+`<td>`+`<div class="md-card card-2">
                    <div class="uk-accordion" data-uk-accordion>
                      ...
                      <div   style="padding:13px 10px 13px 10px" class="col-md-12 col-sm-12 col-xs-12">
                        <select id="item_id_`+x+`" class="md-input itemId select2-single-search-dropdown single_select2" name="item_id[]" onchange="getItemPrice(`+x+`)" required>
                          <option value="">select Product/Service </option>
                          @foreach($product as $value)
                    ...
                    <div class="uk-accordion" data-uk-accordion>
                      ...
                      <div style="margin-top:3px" class="col-md-10 col-sm-8 col-xs-8">
                      <select class="md-input discount_type"  id="discount_type_`+x+`" name="discount_type[]" onchange="calculateActualAmount(`+x+`)" class="md-input itemId select2-single-search-dropdown">
    ...
    <script type="text/javascript">
        $('#dropdown').on('click',function(){
          ...
          $('#custome_hide').append(`
            ...
            <select  class="md-input select2-single-search-dropdown" " id="customer_id" title="Select Customer"  name="customer_id">
            <option value="">Select Name</option>
            @foreach($customers as $customer)
