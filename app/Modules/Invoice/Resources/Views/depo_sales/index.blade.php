                    ...
                    <div class="md-card">
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Primary Sale List</span>
                                    <div style="float: right;margin-top:-29px;padding:0px">
                                        <form action="{{ route('depo_sales') }}" method="get">
                                            <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="user_content">
                                        ...
                                        @foreach ($invoices as $invoice)
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center" style="white-space:nowrap !important;">
                                                    ...
                                                    <a href="{{ route('depo_sales_edit', ['id' => $invoice->id]) }}"><i
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('depo_sales_create') }}"
    ...
    <script>
        ...
        $('.delete_btn').click(function() {
            ...
            swal({
                ...
                window.location.href = "/invoice/depo-sales/delete/" + id;
            })
        })
    </script>
@endsection
