            ...
            <div class="uk-width-large-2-10 hidden-print uk-visible-large">
                <div class="md-list-outside-wrapper">
                    ...
                    <ul class="md-list md-list-outside">
                        ...
                        <li class="heading_list">Product/Service </li>

                        @foreach($invoice_entries as $invoice_entry)
                        <li>
                            <div class="md-list-content">
                                <span class="md-list-heading"><label style="color: #757575;">Product/Service  name:</label>{{ $invoice_entry->item->item_name }}</span>
