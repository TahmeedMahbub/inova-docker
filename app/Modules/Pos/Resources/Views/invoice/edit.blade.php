                            ...
                            <div class="">
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-1-4">
                                        ...
                                        <select class="md-input select2-single-search-dropdown" title="Select Customer" id="customer_id" name="customer_id">
                                            ...
                                            @foreach($customers as $customer)
                                                <option value="{{ $customer->id }}" {{ $customer->id == $invoice->customer_id ? 'selected' : '' }}>{{ $customer->phone_number_1 . ', ' . $customer->display_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div  class="uk-width-medium-1-4">
                                    ...
                                    <div class="uk-width-medium-1-4">
                                        ...
                                        <input class="md-input" type="text" id="new_item_serial" oninput="newserial()" name="new_item_serial">
                                            ...
                                            <tbody class="getMultipleRow">
                                                @foreach($invoice_entry as $key => $invoice_entry_value)
                                                    <tr class="tr_{{$key}}" id="data_clone"  >
                                                        <td>
                                                            <p style="padding-top: 7px; margin-bottom: 0px;">{{ $key + 1 }}</p>
                                                        </td>

                                                        <td style="width: 200px">
                                                            <select id="item_id_{{$key}}" class="md-input itemId select2-single-search-dropdown" 
                                                            name="item_id[]" onchange="getItemPrice(<?php echo $key; ?>)" required>
                                                                <option value="">Select Product/Service</option>
                                                                @foreach($all_inventories as $all_inventories_tmp)
                                                                    <option value="{{ $all_inventories_tmp->id }}" 
                                                                        @if($all_inventories_tmp->id == $invoice_entry_value->item_id) selected @endif>
                                                                        {{ str_pad($all_inventories_tmp->id, '6', '0', STR_PAD_LEFT) . ', ' . $all_inventories_tmp->item_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td class="">
                                                            <input type="text" id="available_stock_{{$key}}" name="available_stock[]" class="md-input serial" 
                                                            value="{{ $invoice_entry_value->item->total_purchases - $invoice_entry_value->item->total_sales + $invoice_entry_value->quantity }}" />
                                                        </td>
                                                        <td class="hidden">
                                                        ...
                                                        <td>
                                                            <input  type="text" id="quantity_{{$key}}" name="quantity[]" class="md-input quantity" value="{{ $invoice_entry_value->quantity }}" oninput="calculateActualAmount(<?php echo $key; ?>)" />
                                                        </td>

                                                        <td>
                                                            <input type="text" id="rate_{{$key}}" name="rate[]" readonly class="md-input rate" value="{{ $invoice_entry_value->rate }}" oninput="calculateActualAmount(<?php echo $key; ?>)" required/>
                                                        </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" id="adjustment_amount" name="adjustment_amount" class="md-input md-input-width-medium low-height-input" 
                                                            value="{{ number_format(abs(($invoice->adjustment * 100) / max(1, $sub_total)), '2') }}" oninput="calculateActualAmount(0)"/>
                                                </td>
                                                <td style="width: 80px">
                                                    <select class="md-input adjustment_type" id="adjustment_type" name="adjustment_type" onchange="calculateActualAmount(0)">
                                                        <option value="1" @if($invoice->adjustment_type == 1) selected @endif>BDT</option>
                                                        <option value="0" @if($invoice->adjustment_type == 1) selected @else selected @endif>%</option>
                                                    </select>
                                                </td>
                                                <td colspan="1">
                                                    ...
                                                    <input type="text" id="adjustment" name="adjustment" class="md-input md-input-width-medium low-height-input" 
                                                            value="{{ $invoice->adjustment }}" oninput="calculateActualAmount(0)" readonly/>
                                                </td>
                                                <td colspan="1">
                                                    <label for="vat">Vat (%)</label>
                                                    <input type="text" id="vat" class="md-input md-input-width-medium low-height-input" value="{{ $tax }}" oninput="calculateActualAmount(0)" />
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td colspan="1">
                                                    ...
                                                    <input type="text" id="shippingCharge" name="shipping_charge" class="md-input md-input-width-medium low-height-input"  value="{{ $invoice->shipping_charge }}" oninput="calculateActualAmount(0)"/>
                                                </td>                                                  
                                                <td style="text-align: right">
                                                ...
                                                <td>
                                                    <label for="fabrics_due">Fabrics Due</label>
                                                    <input type="text" id="fabrics_due" name="fabrics_due" class="md-input md-input-width-medium low-height-input" value="{{ $invoice->fabrics_due ?? 0 }}"/>
                                                </td>
                                                <td>
                                                    <label for="extra_design_charge">Extra Design Charge</label>
                                                    <input type="text" id="extra_design_charge" name="extra_design_charge" class="md-input md-input-width-medium low-height-input" value="{{ $invoice->extra_design_charge ?? 0 }}" oninput="calculateActualAmount(0)" />
                                                </td>
                                            </tr>
                                ...
                                <div class="uk-grid hidden" data-uk-grid-margin>
                                  <div class="uk-width-medium-1-3">
                                      ...
                                      <input class="md-input" type="text" id="no_of_installment" onfocusout="installment()" value="{{ $invoice->no_of_installment }}" name="no_of_installment">
                                  </div>
                                  <div class="uk-width-medium-1-3">
                                      <label for="invoice_date">Time Interval</label>
                                      <input class="md-input" type="text" id="time_interval" onfocusout="installment()" value="{{ $invoice->day_interval }}"  name="time_interval">
                                  </div>
                                    <div class="uk-width-medium-1-3">
                                        <label for="invoice_date">Start Sate</label>
                                        <input class="md-input" type="text" id="start_date" onfocusout="installment()" name="start_date"value="{{ date('d-m-Y',strtotime($invoice->start_date ?$invoice->start_date :Carbon\Carbon::now()->format('d-m-Y'))) }}" data-uk-datepicker="{format:'DD-MM-YYYY'}">
                                    </div>
                                </div>

                                @if( $invoice->day_interval > 0 && $invoice->no_of_installment > 0 )
                                   ...
                                   <div class="uk-width-medium-4-4">
                                    <table class="input_fields_wrap uk-table">
                                      ...
                                      <tr>
                                        ...
                                        @foreach($due_balance as $key=>$value)
                                          <tr>
                                            <td>
                                   ...
                                   <div class="uk-width-medium-4-4">
                                    ...
                                    @foreach($due_balance as $key=>$value)
                                        <tr>
                                            ...
                                            <td>
                                            <input class="md-input amount_value" type="text" id="due_ammount_0" value="{{$value->amount}}" onchange="valcheck(0)" id="due_date" name="amount_val[]"  >
                                            </td>
                                            <td style="text-align: center">
                                    ...
                                    <table class="input_fields_wrap uk-table">
                                     ...
                                     @endphp
                                      ...
                                      <tr>
                                        ...
                                        @else
                                            <a  class="remove_date_amount remove_field " ><i style="padding-top: 5px"  class="material-icons md-36" >delete</i></a>
                                        @endif
                                        </td>
                                      </tr>
                                      @php
...
@section('scripts')
    ...
    <script type="text/javascript">
        $('#document').ready(function(){
            ...
            var invoiceEntry      = <?php echo $invoice_entry; ?>;
    ...
    <script type="text/javascript">
        ...
        function calculateActualAmount(x)
        {
            ...
            var fabrics_due             = $("#fabrics_due").val();
            var extra_design_charge     = $("#extra_design_charge").val();
            ...
            if(vat =='' || vat == 0.00)
            {
                ...
                var vat_val     = vat;
                var vat_cal     = Math.round(((parseFloat(subTotal) + parseFloat(adjustment_value)) * parseFloat(vat_val))/100);
                var vat_show    = Math.round(parseFloat(vat_cal) + parseFloat(subTotal));
            }
            ...
            if(extra_design_charge =='' || extra_design_charge ==0.00)
            {
                var extra_design_charge  = 0;
            }
            else {
                var extra_design_charge  =  extra_design_charge;
            }

            var total_amount     = Math.round(parseFloat(adjustment_value) + parseFloat(shippingCharge_val) + parseFloat(extra_design_charge) + parseFloat(vat_cal) + parseFloat(subTotal));
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            var commission_type             = $('#commission_type').val();
            var commission                  = "<?php echo $invoice->commission_type ;?>";
            var total_commission_amount     = "{{$invoice->agentcommissionAmount}}";
              var sub_total                 = $('#subTotal').val();
