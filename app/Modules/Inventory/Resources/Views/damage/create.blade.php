...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('damage_store'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Add Damage</span></h2>
                                </div>
                            </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-4">
                                            <label for="quantity_ctn_0">Quantity(ctn)<span style="color: red;"
                                                class="asterisc">*</span></label>
                                            <input class="md-input input-cls" type="text" id="quantity_ctn_0" name="quantity_ctn" value="1" oninput="calculateCtnToPcs(this)" required/>
                                        ...
                                        <div class="uk-width-medium-1-4">
                                            <label for="quantity_pcs_0">Quantity(pcs)<span style="color: red;"
                                                class="asterisc">*</span></label>
                                            <input class="md-input input-cls"  type="text" id="quantity_pcs_0" name="quantity_pcs" value="1" oninput="calculatePcsToCtn(this)" required/>
