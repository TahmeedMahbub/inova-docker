                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create Product/Service </span></h2>
                            </div>
                        </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-1-4">
                                        ...
                                        <input class="md-input input-cls" type="text" id="item_name" name="item_name"
                                            oninput="nameUpdate()" value="{{ old('subject_name') }}" required />
                                                ...
                                                <tr class="tr_0" id="data_clone">
                                                    ...
                                                    <td id="tr_0_attribute" style="padding-top: 25px; position: relative;"
                                                        ...
                                                        <select id="attribute_id_0_0"
                                                            class="select2-single-search-dropdown" name="attribute[0][]"
                                                            onchange="populateValues(this)">
                                                            <option value="">Select Attribute</option>
                                                            @foreach ($attributes as $attribute)
                                                                <option value="{{ $attribute->id }}">
    ...
    <script>
        ...
        $(add_button).click(function(e) {
            ...
            if (x < max_fields) {
                ...
                $('.getMultipleRow').append(' ' + '<tr class="tr_' + x + '">' +
                    ...
                    '_0" class="select2-single-search-dropdown" name="attribute[' + x + '][]"' +
                    'onchange="populateValues(this)" required>' +
                    '<option value="">Select Attribute</option>' +
                    '</select>' +
                    '</td>' +
                    ...
                    '" name="variation_name_id[]" class="md-input" value="" required>\n<span class="md-input-bar"></span></div>' + '</td>\n' +
                ...
                `<div class="uk-width-medium-1-4" id="item-attr-section-${current_section}" style="display: flex">
                    <div class="md-input-wrapper">
                        ...
                        <select id="item_attributes_value_0_${current_section}"
                            class="select2-single-search-dropdown value-select2"
                            name="item_attributes_value[]" onchange="" required>
                            <option value="">Select Value</option>
                        </select>
                        @if ($errors->has('item_attributes_value.*.*'))
                            <div class="uk-text-danger uk-text-center ">Values must be
        ...
        function addAttributeSection(e) {
            ...
            $('#tr_' + current_row + '_attribute a:first-child').after(
                ...
                'name="attribute[' + current_row + '][]" onchange="populateValues(this)" required>\n' +
                '<option value="">Select Attribute</option>\n' +
                '</select>\n'
            );
        ...
        $('#submitAttributeBtn').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var id_prefix = modal_attr_id.replace(/_\d+_\d+$/, "");
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#'+ id_prefix +'_' + row + '_' + column).empty();
                            $('#'+ id_prefix +'_' + row + '_' + column).append($(
                                '<option>', {
                                    value: '',
                                    text: 'Select Value',
                                }));
                ...
                error: function(data) {
                    ...
                    UIkit.notify({
                        message: Object.values(data.responseJSON.errors)[0][0],
                        status: 'danger',
                        timeout: 2000,
                        pos: 'top-right'
                    });
        ...
        $('.sop_files').imageUploader({
            required:false,
            imagesInputName: "sop_file",
            multiple:true
        });
        $('.design_files').imageUploader({
            required:false,
