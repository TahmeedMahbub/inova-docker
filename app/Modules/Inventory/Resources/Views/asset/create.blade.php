...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('asset_store'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Create Assets </span></h2>
                                </div>
                            </div>
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-2">
                                            <label for="subject_name">Product/Service  Name<span style="color: red;" class="asterisc">*</span></label>
                                            <input class="md-input input-cls"  type="text" id="item_name" name="item_name" oninput="nameUpdate()" value="{{ old('item_name') }}" required/>
                                        ...
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <input class="md-input input-cls"  type="text" id="barcode_no" name="barcode_no" value="{{ old('barcode_no') }}"/>
                                    ...
                                    <!--    <div class="uk-grid" data-uk-grid-margin>
                                     ...
                                     <div class="uk-width-medium-1-2">
                                          <label class="" for="item_name">@lang('trans.name')<span style="color: red;" class="asterisc">*</span></label>
                                            <input class="md-input label-fixed" type="text" id="item_name" name="item_name" value="{{ old('item_name') }}" required/>
                                            @if($errors->has('item_name'))
                                                <div class="uk-text-danger uk-margin-top">{{ $errors->first('item_name') }}</div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                            <!-- <label class="uk-vertical-align-middle" for="item_sales_rate">@lang('trans.rate')</label> -->
                                ...
                                <!-- <h3 class="full_width_in_card heading_c">
                                        <span class="">
                                            <label for="purchase_information" class="inline-label">Item Payment Information</label>
                                        </span>
                                    </h3> -->
                                    <!-- <label class="uk-vertical-align-middle" for="item_purchase_rate">@lang('trans.rate')</label> -->
                                        <div class="uk-width-medium-1-3">
                                            <label for="item_purchase_rate">Buy Rate</label>
                                            <input class="md-input" type="number" id="item_purchase_rate" name="item_purchase_rate" value="{{old('item_purchase_rate')}}"/>
                                        </div>
                                        <div class="uk-width-medium-1-3">
                                    ...
                                    <!-- <h3 class="full_width_in_card heading_c">
                                        <span class="">
                                            <label for="sales_information" class="inline-label">Registration Information</label>
                                        </span>
                                    </h3> -->
