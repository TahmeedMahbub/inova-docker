                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">All Assets </span></h2>
                                </div>
                            ...
                            <div class="user_content">
                                ...
                                <div class="md-fab-wrapper branch-create">
                                    <a id="add_branch_button" href="{{ route('asset_create') }}"
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var all_inventory_list = "{{ route('inventory_api_all_asset_list') }}";
        var all_inventory_find = "{{ route('inventory_api_seach_asset_items_key') }}";
        var all_inventory_edit = "{{ route('asset_edit', ['id' => '']) }}";
        ...
        var all_inventory_delete = "{{ route('asset_delete', ['id' => '']) }}";
        var stock_report = "";
        var item_report = "";
        ...
        $(".alldata").on("click", function() {
            ...
            $.get(all_inventory_list, function(datalist) {
                ...
                $.each(datalist, function(k, v) {
                    ...
                    data.push([++k, v.item_name, v.item_purchase_rate || '0', v
                        .item_category_name || ' ', actiondata
                    ]);
                });
                ...
                $('#data_table_1').DataTable({
                    ...
                    "columnDefs": [{
                        ...
                        "render": function(link, type, row) {
                            ...
                            inventory_url += "<a href=" + all_inventory_edit + "/" +
                                link.id + ">" +
                                '<i data-uk-tooltip="{pos:\'top\'}" title="@lang('trans.edit')" class=" material-icons">&#xE254;</i>' +
                                "</a>";
                            inventory_url += "<a href=" + all_inventory_barcode + "/" +
                                link.id + ">" +
                                '<i data-uk-tooltip="{pos:\'top\'}" title="Barcode" class="md-icon material-icons">view_week</i>' +
                                "</a>";
                            inventory_url +=
                                "<a onclick='removeItem(this);' class='delete_btn'><i data-uk-tooltip=\"{pos:'top'}\" title='@lang('trans.delete')' class='material-icons'>&#xE872;</i></a>";
                            inventory_url +=
                                "<input class='inventory_id' type='hidden' value=" +
                                all_inventory_delete + '/' + link.id + ">";
