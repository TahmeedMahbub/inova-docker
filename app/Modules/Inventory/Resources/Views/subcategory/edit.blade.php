                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                      <label for="item_category_name" class="">@lang('trans.category_name')</label> <br>
                                        <select id="item_category_id" name="item_category_id"  class="select2-single-search-dropdown"  required>
                                            <option value="">@lang('trans.select_category_name')</option>
                                            @foreach($categories as $category)
                                                <option {{ $categoryById->item_category_id ==  $category->id ? 'selected' : '' }}  value="{{ $category->id }}"> @if(Session::get('locale') == 'bn') {{ $category->item_category_name }} @else {{ $category->item_category_name }} @endif </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        <label for="item_sub_category_name">Sub Category Name</label>
                                        <input  type="text" id="item_sub_category_name" value="{{ $categoryById->item_sub_category_name}}" class="select2-single-search-dropdown" name="item_sub_category_name"  required/>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-4">
                                        <label for="item_sub_category_description">Sub Category Discription</label>
                                        <textarea class="md-input" name="item_sub_category_description" id="item_sub_category_description" cols="30" rows="4">{{ $categoryById->item_sub_category_description }}</textarea>
                                    </div>
                                </div>
