                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create Sub Category</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-5-5">
                                        ...
                                        <textarea class="md-input" name="item_sub_category_description" id="item_sub_category_description" cols="30" rows="4"></textarea>
                                    </div>
                                </div>
