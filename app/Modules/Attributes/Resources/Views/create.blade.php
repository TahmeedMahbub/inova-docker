                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('attribute_store'), 'method' => 'POST']) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-1">
                                        <label for="attribute_name">Attribute Name</label>
                                        <input class="md-input" type="text" id="attribute_name" name="attribute_name"
                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-1-1">
                                        <div id="attribute_values_container" class="uk-grid">
                                            <div id="value_0"
                                                class="uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 uk-margin-medium-top">
                                                <div class="uk-input-group">
                                                    <label for="attributes_value_0">Value</label>
                                                    <input type="text" class="md-input" name="attributes_value[]"
                                                        id="attributes_value_0" value="{{ old('attributes_value.0') }}"/>
                                                    <span class="uk-input-group-addon">
                                                        <a href="#" class="btnSectionClone"
                                                            onclick="addSection(this)"><i
