                                    ...
                                    {!! Form::open(['url' => route('category_store'), 'method' => 'POST']) !!}
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-5 uk-vertical-align">
                                                <label for="contact_category_name" class="uk-vertical-align-middle">Name<span style="color: red;" class="asterisc"> *</span></label>
                                            </div>
                                        ...
                                        <div class="uk-grid">
                                            <div class="uk-width-medium-1-5 uk-vertical-align">
                                                <label for="contact_category_description" class="uk-vertical-align-middle">Description<span style="color: red;" class="asterisc"> *</span></label>
                                            </div>
