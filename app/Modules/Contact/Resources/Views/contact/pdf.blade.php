...
@section('title', 'All Contact Report')
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b">All Contact List</p>
                            </div>
                        </div>
                        <div class="uk-grid" >
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Institution Name</th>
                                        <th style="font-size: 10px">Email</th>
                                        <th style="font-size: 10px">Phone Number</th>
                                        <th style="font-size: 10px">Guardian Contact Number</th>
                                        <th style="font-size: 10px">Present Address</th>
