                    ...
                    <div class="md-card">
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Money Received</span></h2>
                            </div>
                        </div>
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($paymentreceives as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->account_id == 3 ? 'CR' : 'BR' }}-{{$data->pr_number}}</td>
                                            ...
                                            <td>
                                                ...
                                                <?php echo number_format((float)$amount, 2, '.', '');?> BDT
                                                @else
                                                0.00 BDT
                                                @endif
                                            </td>
                                            <td class="uk-text-center">
                                                @if ($data->cheque_status == 'unpresented')
                                                    <a href="{{ route('draw_cheque', ['id' => $data->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Draw Cheque" class="md-icon material-icons">check</i></a>
                                                @endif
