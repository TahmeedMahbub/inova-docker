...
class CreditNoteRefundWebController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $credit_note->available_credit      = ($credit_note->available_credit + $credit_note_refund->amount - $credit_note_amount);
        $credit_note->update();
        ...
        if($credit_note_refund->update())
        {
            ...
            $created = JournalEntry::where('credit_note_refunds_id', $id)->first();
    ...
    public function destroy($id)
    {
        ...
        $credit_note = CreditNote::find($credit_note_refund['credit_note_id']);
        $credit_note->available_credit = $credit_note->available_credit + $credit_note_refund->amount;
        $credit_note->update();
