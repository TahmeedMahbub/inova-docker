                            ...
                            <a href="{{ route('credit_note_show', ['id' => $credit_note_data->id]) }}" class="md-list-content">
                                <span class="md-list-heading uk-text-truncate">
                                   CN-{{ $credit_note_data->credit_note_number }}
                                    <span class="uk-text-small uk-text-muted">{{ date('d-m-Y',strtotime($credit_note_data->credit_note_date)) }}, <br>{{ $credit_note_data->customer->display_name }}</span>
                                </span>
                            </a>
                        </li>
                        @endforeach
                    ...
                    <div id="invoice_preview">
                        ...
                        <div class="md-card-content invoice_content print_bg" style="height: 301px;">
                            ...
                            <div class="" style="text-align: center;">
                              ...
                              <p>@php echo nl2br($credit_note->customer->billing_address); @endphp</p>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-small-1-2 uk-row-first">
                                    <div class="uk-margin-bottom">
                                        <span class="uk-text-muted uk-text-small uk-text-italic">Credit Note To:</span>
                                        <address>
                                          <address>
                                              <p><strong>{{ $credit_note->customer->display_name }}</strong></p>
                                              <p>@php echo nl2br($credit_note->customer->billing_address); @endphp</p>
                                              <p>{{ $credit_note->customer->phone_number_1 }}</p>
                                ...
                                <div class="uk-width-small-1-2">
                                    <table class="uk-table inv_top_right_table">
                                        <tr class="uk-table-middle">
                                            ...
                                            <td class="uk-text-right no-border-bottom">{{ date('d-m-Y', strtotime($credit_note->credit_note_date)) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="uk-grid uk-margin-large-bottom">
                                <div class="uk-width-1-1 table-responsive">
                                    <table border="1" class="uk-table table">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($credit_note_entries as $credit_note_entry)
                                                <tr class="uk-table-middle">
                                                    ...
                                                    <td class="uk-text-right">{{ $credit_note_entry->unit_id?$credit_note_entry->quantity/$credit_note_entry->basic_unit_conversion.' '.$credit_note_entry->unit['name'].' '.$credit_note_entry->item['unit_type']:'' }}</td>
                                ...
                                <div class="uk-width-1-1 table-responsive">
                                    <table class="uk-table table">
                                        ...
                                        <tr class="uk-table-middle">
                                            ...
                                            <td class="uk-text-right">{{ $refund->amount }}</td>
                                    ...
                                    <table class="uk-table table">
                                        ...
                                        @foreach($credit_note->creditNotePayments as $payment)
                                            <tr class="uk-table-middle">
                                                ...
                                                <td>INV-{{ $payment->invoice->invoice_number }}</td>
