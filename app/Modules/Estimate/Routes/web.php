...
Route::group(['prefix' => 'estimate-request', 'middleware' => 'auth'], function () {

    Route::get('/', 'EstimateWebController@estimateRequest')->name('estimate.request.index')->middleware('read_access');
    Route::get('/create', 'EstimateWebController@estimateRequestCreate')->name('estimate.request.create')->middleware('create_access');
    Route::get('/edit/{id}', 'EstimateWebController@estimateRequestEdit')->name('estimate.request.edit')->middleware('read_access');
    Route::post('/store', 'EstimateWebController@estimateRequestStore')->name('estimate.request.store')->middleware('create_access');
    Route::post('/update/{id}', 'EstimateWebController@estimateRequestUpdate')->name('estimate.request.update')->middleware('update_access');
    Route::get('/show/{id}', 'EstimateWebController@estimateRequestShow')->name('estimate.request.show')->middleware('read_access');
    Route::post('/destroy', 'EstimateWebController@estimateRequestDelete')->name('estimate.request.delete')->middleware('delete_access');
});
