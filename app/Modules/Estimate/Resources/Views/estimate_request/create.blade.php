                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Quotation</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                <div class="uk-grid uk-margin-medium-bottom" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2 uk-margin-medium-top" style="font-size: 20px;">
                                        @if (!empty(old('order_code')))
                                            @php
                                                $expData = explode('-', old('order_code'));
                                            @endphp
                                            <strong>Order Code:</strong> <span>{{ $expData[0] . '-' . $expData[1] }}-<span
                                                    id="order_quantity">{{ $expData[2] }}</span></span>
                                        @else
                                            <strong>Order Code:</strong> <span>{{ $order_code }}<span
                                                    id="order_quantity">0</span></span>
                                        @endif
                                        <input type="hidden" name="order_code"
                                            value="{{ !empty(old('order_code')) ? old('order_code') : $order_code . '0' }}">
                                    </div>
                                    <div class="uk-width-medium-1-2 uk-margin-small-top">
                                        <label class="" for="date">Date<sup><i
                                                    style="color:red; font: 14px; ">*</i></sup></label>
                                        <input class="md-input @if ($errors->first('date')) md-input-danger @endif"
                                            id="date" type="text" name="date"
                                            value="@if (old('date')) {{ old('date') }}@else{{ Carbon\Carbon::now()->format('d-m-Y') }} @endif"
                                ...
                                {{-- model start --}}
                                <div id="card-model">
                                    @if (!empty(old('model_name')))
                                        @foreach (old('model_name') as $key => $model)
                                                ...
                                                <div class="md-card-content">
                                                    <div class="uk-grid">
                                                        <div class="uk-width-medium-1-2">
                                                            <div class="md-input-wrapper">
                                                                <label for="model_name">Model Name <sup><i
                                                                            style="color:red; font: 14px; ">*</i></sup></label>
                                                                <input
                                                                    class="md-input @if ($errors->first('model_name.' . $key)) md-input-danger @endif"
                                                                    id="model_name" type="text" name="model_name[]"
                                                                    value="{{ old('model_name')[$key] }}">
                                                                @if ($errors->first('model_name.' . $key))
                                                                    <p style="color:red;">
                                                                        {{ $errors->first('model_name.' . $key) }}</p>
                                                                @endif
                                                        ...
                                                        @if ($key !== 0)
                                                            <div class="uk-width-medium-1-2">
                                                                <button type="button"
                                                                    class="md-btn md-btn-small md-btn-flat md-btn-flat-primary uk-float-right uk-margin-small-left delete_model"
                                                                    data-model="#model-{{ $model }}"
                                                                    style="display: table;margin-left: auto;"><i
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="input_fields_wrap uk-table table">
                                                            <thead>
                                                                <tr>
                                                                    <th>Length <span style="color: red;"
                                                                            class="asterisc">*</span></th>
                                                                    <th>Size</th>
                                                                    <th>Color</th>
                                                                    <th>Quantity <span style="color: red;"
                                                                            class="asterisc">*</span></th>
                                                                    <th>Action</th>
                                                                </tr>
                                                            </thead>
                                                            ...
                                                            <tbody class="getMultipleRow">
                                                                @foreach (old('length')[$key] as $key1 => $value)
                                                                    <tr class="tr_0" id="data_clone">
                                                                        <td>
                                                                            <div class="md-input-wrapper md-input-filled">
                                                                                <input type="text"
                                                                                    name="length[{{ $key }}][]"
                                                                                    value="{{ old('length')[$key][$key1] }}"
                                                                                    class="md-input label-fixed @if ($errors->first('length.' . $key . '.' . $key1)) md-input-danger @endif"
                                                                                    placeholder="Enter Length">
                                                                                <span class="md-input-bar "></span>
                                                                            </div>
                                                                            @if ($errors->first('length.' . $key . '.' . $key1))
                                                                                <p style="color:red;">
                                                                                    {{ $errors->first('length.' . $key . '.' . $key1) }}
                                                                                </p>
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <div class="md-input-wrapper md-input-filled">
                                                                                <input type="text"
                                                                                    name="size[{{ $key }}][]"
                                                                                    value="{{ old('size')[$key][$key1] }}"
                                                                                    class="md-input label-fixed @if ($errors->first('size.' . $key . '.' . $key1)) md-input-danger @endif"
                                                                                    placeholder="Enter Size">
                                                                                <span class="md-input-bar "></span>
                                                                            </div>
                                                                            @if ($errors->first('size.' . $key . '.' . $key1))
                                                                                <p style="color:red;">
                                                                                    {{ $errors->first('size.' . $key . '.' . $key1) }}
                                                                                </p>
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <div class="md-input-wrapper md-input-filled">
                                                                                <input type="text"
                                                                                    name="color[{{ $key }}][]"
                                                                                    value="{{ old('color')[$key][$key1] }}"
                                                                                    class="md-input label-fixed @if ($errors->first('color.' . $key . '.' . $key1)) md-input-danger @endif"
                                                                                    placeholder="Enter Color">
                                                                                <span class="md-input-bar "></span>
                                                                            </div>
                                                                            @if ($errors->first('color.' . $key . '.' . $key1))
                                                                                <p style="color:red;">
                                                                                    {{ $errors->first('color.' . $key . '.' . $key1) }}
                                                                                </p>
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <div class="md-input-wrapper md-input-filled">
                                                                                <input type="number"
                                                                                    name="quantity[{{ $key }}][]"
                                                                                    min="1"
                                                                                    value="{{ old('quantity')[$key][$key1] }}"
                                                                                    class="md-input label-fixed quantity @if ($errors->first('quantity.' . $key . '.' . $key1)) md-input-danger @endif"
                                                                                    oninput="totalQuantity()"
                                                                                    placeholder="Enter Quantity">
                                                                                <span class="md-input-bar"></span>
                                                                            </div>
                                                                            @if ($errors->first('quantity.' . $key . '.' . $key1))
                                                                                <p style="color:red;">
                                                                                    {{ $errors->first('quantity.' . $key . '.' . $key1) }}
                                                                                </p>
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            @else
                                                                                <button type="button"
                                                                                    class="md-btn md-btn-small md-btn-flat md-btn-flat-primary uk-float-right uk-margin-small-left remove_data"><i
                                                                                        class="material-icons">&#xe872;</i></button>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="uk-grid">
                                                    <div class="uk-width-medium-1-2">
                                                        <div class="md-input-wrapper">
                                                            <label for="model_name">Model Name <sup><i
                                                                        style="color:red; font: 14px; ">*</i></sup></label>
                                                            <input class="md-input" id="model_name" type="text"
                                                                name="model_name[]">
                                                                ...
                                                                <td>
                                                                    <div class="md-input-wrapper md-input-filled">
                                                                        <input type="number" name="quantity[0][]"
                                                                            min="1"
                                                                            class="md-input label-fixed quantity"
                                                                            oninput="totalQuantity()"
                                                                            placeholder="Enter Quantity">
                                                                        <span class="md-input-bar"></span>
                                                                    </div>
                                ...
                                <button type="button" id="add-new-model"
                                    class="md-btn md-btn-success md-btn-wave-light waves-effect waves-button waves-light uk-margin-medium-bottom"
                                    style="margin: auto;display: block;">Add Model</button>
                                ...
                                <div class="uk-grid">
                                        ...
                                        <div class="uk-form-row uk-margin-medium-top">
                                            <div class="md-input-wrapper">
                                                ...
                                                <textarea cols="30" rows="1"
                                                    class="md-input no_autosize @if ($errors->first('note')) md-input-danger @endif" name="note"
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <div class="md-input-wrapper uk-margin-medium-top">
                                            ...
                                            <input type="text"
                                                class="md-input @if ($errors->first('deadline')) md-input-danger @endif"
                                                name="deadline" id="deadline" data-uk-datepicker="{format:'DD-MM-YYYY'}"
                                                value="{{ old('deadline') }}">
                                            <span class="md-input-bar "></span>
...
@section('scripts')
    ...
    <script>
        ...
        function totalQuantity() {
            ...
            $('input[name="order_code"]').val("{{ $order_code }}" + total);
