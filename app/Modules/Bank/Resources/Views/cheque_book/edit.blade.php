...
@section('title', 'Cheque Book Edit')
...
@section('content')
    <div class="uk-width-large-10-10">
        {!! Form::open([
            'url' => route('cheque_book_update', ['id' => $cheque_book->id]),
            'method' => 'POST',
                        ...
                        <div class="uk-margin-top">
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-3 uk-margin-small-top">
                                    ...
                                    <input class="md-input" type="text" id="collection_date" name="collection_date"
                                        value="{{ date('d-m-Y', strtotime($cheque_book->book_collection_date)) }}"
                                    ...
                                    <select title="Select Customer" id="branch_id" name="branch_id"
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}"
                                                {{ $branch->id == $cheque_book->branch_id ? 'selected' : '' }}>
                                    ...
                                    <select title="Select Customer" id="bank_id" name="bank_id"
                                        ...
                                        @foreach ($banks as $bank)
                                            <option value="{{ $bank->id }}"
                                                {{ $bank->id == $cheque_book->bank_id ? 'selected' : '' }}>
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-3">
                                    ...
                                    <input class="md-input" type="number" id="start_page_no" name="start_page_no"
                                        value="{{ $cheque_book->start_page_no }}" required />
                                ...
                                <div class="uk-width-medium-1-3">
                                    ...
                                    <input class="md-input" type="number" id="number_of_pages" name="number_of_pages"
                                        value="{{ $cheque_book->number_of_pages }}" required />
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-1-1 uk-text-right">
                                    <button type="button" onclick="location.href = '/cheque-book/';"
                                        class="md-btn md-btn-flat uk-modal-close">Close</button>
