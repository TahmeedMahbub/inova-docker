...
Route::group(['prefix' => 'api/account-chart', 'middleware' => 'auth'], function (){
    Route::get('/get-account-chart', 'AccountChartWebController@getAccountChartFixedAsset')->name('get_account_chart');
});
