                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['route' => 'bill_search_pending_bill', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Pending Bill List</span></h2>
                            </div>
                        </div>
                                ...
                                <table class="uk-table" cellspacing="0" style="overflow:auto" width="100%" id="data_table" >
                                    ...
                                    @foreach($bills as $bill)
                                        <tr>
                                            ...
                                            <td class="uk-text-right">{{ $bill->amount }} </td>

                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                <a href="{{ route('pending_bill_approval', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Approval" class="material-icons">check_box</i></a>
                                              <a href="{{ route('bill_submit_show', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="View" class="material-icons">visibility</i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
...
@section('scripts')
    <script>
        ...
        $('#sidebar_bill_submit_pending').addClass('act_item');
