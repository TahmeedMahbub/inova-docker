...
@section('content')
    <div class="uk-grid" ng-controller="BillSubmitEditController">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('pending_bill_update',['id' => $bill->id]), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
            <div class="uk-margin-top">
                ...
                <div class="uk-grid uk-margin-small-top" data-uk-grid-margin>
                  <div class="uk-width-medium-1-1" style="overflow:auto">
                      ...
                      <table style="display:none;float:right;margin-top:-20px !important "  cellspacing="0" style="overflow:auto" width="100%"class="add_table">
                        <tr>
            ...
            <div class="uk-grid uk-ma" data-uk-grid-margin>
               <div class="uk-width-1-1 uk-float-left">
                   ...
                   <button type="submit" class="md-btn md-btn-primary" name="reject" value="1">Reject Bill</button>
