                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['route' => 'bill_search_submit', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Bill Submit List</span></h2>
                            </div>
                        </div>
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    <tr>
                                        ...
                                        <th class="uk-text-right">Balance Due</th>
                                    ...
                                    @foreach($bills as $bill)
                                        <tr>
                                            ...
                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                ...
                                                <a href="{{ route('bill_submit_edit', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ url('billsubmit/create') }}" class="md-fab md-fab-accent branch-create">
