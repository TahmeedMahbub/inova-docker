                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label for="tax_description" class="uk-vertical-align-middle">Branch Prefix</label>
                                    </div>
                                    <div class="uk-width-medium-4-5">
                                        <label for="prefix">Branch Prefix</label>
                                        <input class="md-input" type="text" id="prefix" name="prefix" value="{{ $branch->branch_prefix }}"/>
                                        @if($errors->first('prefix'))
                                            <div class="uk-text-danger">{{ $errors->first('prefix') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="uk-grid">
