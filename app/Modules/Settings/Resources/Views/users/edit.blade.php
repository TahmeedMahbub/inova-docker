                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label for="display_name" class="uk-vertical-align-middle">Name</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <label for="display_name">Name</label>
                                        <input class="md-input" type="text" id="display_name" name="display_name" value="{{ $user->name }}"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label for="name" class="uk-vertical-align-middle">Fingerprint ID</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <label for="name">Fingerprint ID</label>
                                        <input class="md-input" type="number" id="finger_print_id" name="finger_print_id" value="{{ $user->finger_print_id }}" readonly/>
                                ...
                                <div class="uk-grid" id="contact_id_container" data-uk-grid-margin 
                                @if ($user->role_id != 2)
                                    style="display: none;"                                    
                                @endif>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select id="contact_id" name="contact_id" data-md-selectize>
                                            ...
                                            @foreach($contacts as $contact)
                                                <option value="{{ $contact->id }}" {{ $user->contact_id == $contact->id ? 'selected' : '' }}>{{ $contact->display_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="contact" name="phone_number_1" value="{{ $user->phone }}" />
    ...
    <script type="text/javascript">
        ...
        $('#role_id').change(function (e) { 
            ...
            if($(this).val() == 2){
                ...
                $('#contact_id').selectize()[0].selectize.setValue('');
            }
        });
    </script>
@endsection