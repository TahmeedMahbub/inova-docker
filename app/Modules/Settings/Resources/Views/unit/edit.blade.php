                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Unit</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('settings_unit_update', ['id' => $unit->id]), 'method' => 'POST']) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="name" name="name" value="{{ $unit->name }}" required/>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        ...
                                        <input class="md-input" readonly type="text" id="basic-unit-conversion" name="basic_unit_conversion" value="{{ $unit->basic_unit_conversion }}"  />
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        <label for="location">Enter Base Unit </label>
                                        <input class="md-input" type="text" id="basic-unit-conversion" name="basic_unit_conversion" value="{{ $unit->basic_unit_conversion }}" required/>
                                        @if($errors->first('basic_unit_conversion'))
                                            <div class="uk-text-danger">{{ $errors->first('basic_unit_conversion') }}</div>
                                        @endif
                                    </div>
