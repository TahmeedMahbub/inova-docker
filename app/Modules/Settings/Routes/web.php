...
Route::group(['prefix' => 'settings/quotation/header'], function () {
    Route::get('/', 'invoice\QuotationHeaderController@edit')->name('quotation_header')->middleware(['auth', 'super_admin']);
    Route::post('update', 'invoice\QuotationHeaderController@update')->name('quotation_header_update')->middleware(['auth', 'super_admin']);
});
...
Route::group(['prefix' => 'settings/item/hide-show-settings','middleware' => 'auth'], function () {

    Route::get('/', 'ItemHideShowController@index')->name('settings_hide_show_index');
    Route::post('/store', 'ItemHideShowController@store')->name('settings_hide_show_store');
    Route::get('/list-ajax', 'ItemHideShowController@listAjax')->name('settings_hide_show_list_ajax');
});
// unit
Route::group(['prefix' => 'settings/unit','middleware' => 'auth'], function () {

    Route::get('/', 'UnitController@index')->name('settings_unit_index')->middleware(['auth', 'super_admin']);
    Route::get('/create', 'UnitController@create')->name('settings_unit_create')->middleware(['auth', 'super_admin']);
    Route::post('/store', 'UnitController@store')->name('settings_unit_store')->middleware(['auth', 'super_admin']);
    Route::get('/edit/{id}', 'UnitController@edit')->name('settings_unit_edit')->middleware(['auth', 'super_admin']);
    Route::post('/update/{id}', 'UnitController@update')->name('settings_unit_update')->middleware(['auth', 'super_admin']);
    Route::get('/delete/{id}', 'UnitController@delete')->name('settings_unit_delete')->middleware(['auth', 'super_admin']);
});
// all unit data
Route::group(['prefix' => 'unit', 'middleware' => 'auth'], function () {

    Route::get('/getdata/{id}', 'UnitController@getData')->middleware('auth');
});