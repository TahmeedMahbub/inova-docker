...
@section('title', 'Add Receive Materials')
...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {{ Form::open(['url' => route('phase_receive_store'), 'method' => 'POST', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) }}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Add Receive Material Info</span></h2>
                                </div>
                            </div>
                                    ...
                                    <div class="uk-grid uk-margin-large-bottom" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-1">
                                            <table class="uk-table">
                                                <thead>
                                                    <tr>
                                                        <th class="uk-text-nowrap">Receive Material</th>
