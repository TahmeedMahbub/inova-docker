        ...
        <div class="md-card-content">
            <div class="uk-grid uk-grid-divider" data-uk-grid-margin>
                <div class="uk-width-large-1-3 uk-width-medium-1-2">
                    ...
                    <h5><strong>Business Overview</strong></h5>
                    <ul class="md-list">
                        ...
                        <!-- <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('trail_balance_report')}}"><i class="material-icons">&#xE315;</i>Trial Balance</a></span>
                            </div>
                        </li> -->
                    </ul>

                    <h5><strong>Daily Report</strong></h5>
                    <ul class="md-list">
                    ...
                    <li>
                           <div class="md-list-content reports_list">
                            <span class="md-list-heading"><a href="{{route('expenseLedger')}}"><i class="material-icons">&#xE315;</i>Expense Ledger</a></span>
                      </div>
                  </li>
                ...
                <div class="uk-width-large-1-3 uk-width-medium-1-2">
                   ...
                   <h5><strong>Accountant</strong></h5>
                    <ul class="md-list">
                        ...
                        <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('report_account_general_ledger_search',['branch_id'=>0])}}"><i class="material-icons">&#xE315;</i>General Ledger</a></span>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('report_account_sales_ledger')}}"><i class="material-icons">&#xE315;</i>Sales Report</a></span>
                            </div>
                        </li>

                        <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('report_account_purchase_ledger')}}"><i class="material-icons">&#xE315;</i>Purchase Report</a></span>
                            </div>
                        </li>

                        <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('report_account_received_ledger')}}"><i class="material-icons">&#xE315;</i>Money Received Report</a></span>
                            </div>
                        </li>

                        <li>
                            <div class="md-list-content reports_list">
                                <span class="md-list-heading"><a href="{{route('report_account_payment_ledger')}}"><i class="material-icons">&#xE315;</i>Payment Report</a></span>
                            </div>
                        </li>
                    ...
                    <!--<h5><strong>Item Report</strong></h5>-->
                    <!--<ul class="md-list">-->
                    <!--    <li>-->
                    <!--        <div class="md-list-content reports_list">-->
                    ...
                    <!--    <li>-->
                    <!--        <div class="md-list-content reports_list">-->
                    <!--            <span class="md-list-heading"><a href="{{route('report_contact_wise')}}"><i class="material-icons">&#xE315;</i>Items Sold/Purchased By Contact</a></span>-->
                    <!--        </div>-->
                    <!--    </li>-->
                    <!--</ul>-->
                ...
                <div class="uk-width-large-1-3 uk-width-medium-1-2">
                    ...
                    <hr>
                    <h5><strong>Analytical Report</strong></h5>
                    <ul class="md-list">
                        <!--<li>-->
                        <!--    <div class="md-list-content reports_list">-->
                        ...
                        <!--<li>-->
                        <!--    <div class="md-list-content reports_list">-->
                        <!--        <span class="md-list-heading"><a href="{{route('report_purchase_by_vendor')}}"><i class="material-icons">&#xE315;</i>Purchase By Vendor</a></span>-->
                        <!--    </div>-->
                        <!--</li>-->
                        <li>
                            <div class="md-list-content reports_list">
                                    <span class="md-list-heading"><a href="{{route('report_account_contact_list')}}"><i class="material-icons">&#xE315;</i>Transaction By Contact</a></span>
                        ...
                        <li>
                            <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}">
                                ...
                                <i class="material-icons">&#xE315;</i>
                                    <button class="md-btn">
                                        <span class="md-list-heading">Transaction By Contact (Advanced Filter)</span>
                                        <i class="material-icons">&#xE313;</i>
                                    </button>
                                    ...
                                    <div class="uk-grid uk-dropdown-grid">
                                        ...
                                        <div class="uk-width-1-3">
                                            {!! Form::open(['url' => route('report_account_contact_list_contact_by_search'), 'method' => 'get', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                                                ...
                                                <input autocomplete="off" id="contact_name_search" class="md-input" type="text" name="contact_name" placeholder="Display Name Here" value="">
