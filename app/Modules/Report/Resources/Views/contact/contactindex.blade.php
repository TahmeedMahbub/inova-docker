                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        <div class="uk-grid">
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                @endif
                                <p class="uk-text-large" style="line-height: 6px; margin-top: 10px;">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        @if(app('request')->input('from_date'))
            api_contact_url = "{{ route('report_account_contact_api_list_alpha_search',["from_date"=>app('request')->input('from_date'),"start"=>$start,"end"=>$end,"branch_id"=>$current_branch["id"]]) }}";
        @endif
