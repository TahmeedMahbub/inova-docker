                        ...
                        <div class="md-card-toolbar hidden-print">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div  style="float: left; " data-uk-button-radio="{target:'.md-btn'}">
                                    <a  href="{{url('/report/paiment-receive-break-down/index/'.$start.'/'.$end.'/'.$customer->id)}}" style="color:white ; background-color: #7cb342;" class="md-btn md-btn-wave ">Invoice Wise Payment</a>
                                    <a  href="{{url('/report/paiment-receive-break-down/bill/'.$start.'/'.$end.'/'.$customer->id)}}" style="color:white ; background-color: #7cb342;" class="md-btn md-btn-wave ">Bill Wise Payment</a>
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        ...
                                        <div class="uk-modal-header">
                                            <h3 class="uk-modal-title">Filter Report <i class="material-icons" data-uk-tooltip="{pos:'top'}" title="Filter Report">&#xE8FD;</i></h3>
                                        </div>
                                    ...
                                    <table id="account_filter_table" class="uk-table">
                                        ...
                                        <thead>
                                            <tr style="border-bottom: 1px solid white " class="uk-text-middle">
                                                ...
                                                <th class="uk-text-left" style="width: 10%; vertical-align: top;">{{ Auth::user()->branch_id == 3 ? 'Items/Invoice ID' : 'Transaction ID' }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="border-bottom: 0px solid white " class="uk-text-middle">
                                                ...
                                                <td class="uk-text-right">{{ number_format($balance, 2, '.', '') }}</td>
                                            </tr>
                                                    ...
                                                    @if($key!="invoice")
                                                        ...
                                                        @foreach($type as $contact)
                                                            ...
                                                            <tr class="uk-table-middle">
                                                                ...
                                                                <td class="uk-text-left">{{ $contact['transectionid'] }}
                                                                </td>
                                                                ...
                                                                @if($contact['account_name_id']==5)
                                                                    ...
                                                                    <td class="uk-text-left" style = "vertical-align: top !important;"> 
                                                                        @if (Auth::user()->branch_id == 3)
                                                                            @if (isset($contact->invoice) && $contact->invoice->invoiceEntries)
                                                                                @foreach ($contact->invoice->invoiceEntries as $ie)
                                                                                    <a href="#">{{ $ie->item->item_name }}</a>{{ !$loop->last ? ',' : '' }} <br>
                                                                                @endforeach
                                                                            @endif
                                                                        @else
                                                                            {{ $contact['transectionid'] }} 
                                                                        @endif
                                                                    </td>
                                                                    ...
                                                                    <tr class="uk-table-middle">
                                                                        ...
                                                                        <td class="uk-text-right">
                                                                            @php
                                                                                $balance=$balance-$contact['amount'];
                                                                            @endphp
                                                                            {{ number_format($contact['amount'], 2, '.', '') }}
                                                                        </td>
                                                                        <td class="uk-text-right"> {{ number_format((float)$balance, 2, '.', '') }} </td>
                                                                    </tr>
                                                                @endif
