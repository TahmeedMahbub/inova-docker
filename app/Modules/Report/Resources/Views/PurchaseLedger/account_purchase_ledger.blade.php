                    ...
                    <div id="invoice_preview">
                        <div class="md-card-toolbar">
                            <div style="width: 100%" class="md-card-toolbar-actions hidden-print">
                                ...
                                {!! Form::open(['url' => 'report/account/purchase/ledger', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="md-card-content invoice_content print_bg">
                            ...
                            <div class="uk-grid" data-uk-grid-margin="">
                                ...
                                <div class="uk-width-small-5-5 uk-text-center">
                                    ...
                                    <p style="line-height: 5px;" class="heading_b uk-text-black">Bill Report</p>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-1">
                                    <Strong>Total Bill : {{ (count($bills)) }}</strong>
                                </div>
                            </div>
                                ...
                                <div class="uk-width-1-1">
                                    <table class="uk-table">
                                        ...
                                        <tr class="uk-text-upper">
                                            ...
                                            <th class="uk-text-left">Items</th>
                                            <th class="uk-text-right">Payable</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        @foreach($bills as $bill)
                                            <tr class="uk-text-middle">
                                                <td class="uk-text-left">{{ date('d-m-Y', strtotime($bill['bill_date'])) }}</td>
                                                <td class="uk-text-left">BILL-{{ $bill['bill_number'] }}</td>
                                                <td class="uk-text-left">{{ $bill['customer']->display_name }}</td>
                                                <td class="uk-text-left">{{ $bill['item_name'] }}</td>
                                            ...
                                            @php
                                                ...
                                                $paid_amount    = $paid_amount + ($bill['amount'] - $bill['due_amount']);
                                            @endphp
