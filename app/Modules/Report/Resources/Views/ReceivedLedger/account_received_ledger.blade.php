...
@section('title', 'Money Received Report')
                    ...
                    <div id="invoice_preview">
                        <div class="md-card-toolbar">
                            <div style="width: 100%" class="md-card-toolbar-actions hidden-print">
                                ...
                                {!! Form::open(['url' => 'report/account/received/ledger', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="md-card-content invoice_content print_bg">
                            ...
                            <div class="uk-grid" data-uk-grid-margin="">
                                ...
                                <div class="uk-width-small-5-5 uk-text-center">
                                    ...
                                    <p style="line-height: 5px;" class="heading_b uk-text-black">Money Received Report</p>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-1">
                                    <Strong>Total Receive : {{ (count($payment_receives)) }}</strong>
                                </div>
                            </div>
                                    ...
                                    <table class="uk-table">
                                        ...
                                        @foreach($payment_receives as $payment_receive)
                                            <tr class="uk-text-middle">
                                                ...
                                                <td class="uk-text-left">{{ date('d-m-Y', strtotime($payment_receive['payment_date'])) }}</td>
                                                <td class="uk-text-left">{{ $payment_receive_entry->paymentReceive['account_id'] == 3 ? 'CR' : 'BR' }}-{{ $payment_receive['pr_number'] }}</td>
                                                <td class="uk-text-left">{{ $payment_receive['reference'] }}</td>
                                                <td class="uk-text-left">{{ $payment_receive->paymentContact->display_name }}</td>
                                                <td class="uk-text-right">{{ $payment_receive['amount'] }}</td>
                                            </tr>

                                            @php
                                                $total_amount       = $total_amount + $payment_receive['amount'];
                                            @endphp
