...
@section('title', 'Invoice-Wise Payment')
                    ...
                    <div id="invoice_preview">
                        <div class="md-card-toolbar">
                            <div style="width: 100%" class="md-card-toolbar-actions hidden-print">
                                ...
                                {!! Form::open(['url' => url('/report/paiment-receive-break-down/index/'.$start.'/'.$end.'/'.$id), 'method' => 'GET', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                                ...
                                <div class="uk-width-small-5-5 uk-text-center">
                                    ...
                                    <p style="line-height: 5px; font-sixe:15px"> Invoice Wise Report</p>
                                ...
                                <div class="uk-width-1-1">
                                    <table class="uk-table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($invoice_pr as $data)
                                            
                                                <?php $balance = $data->total_amount; ?>
                                                
                                                <tr class="uk-text-upper">
                                                  
                                                    <td  class="uk-text-left">{{date('d-m-Y', strtotime($data->invoice_date))}}</td>
                                                    <td  class="uk-text-left">INV-{{$data->invoice_number}}</td>
                                                    ...
                                                    ?></td>
                                                    <td class="uk-text-right">{{$data->total_amount}}</td>
                                                    <td  class="uk-text-right"></td>
                                                    <td  class="uk-text-right"></td>
                                                    
                                                </tr>
                                              
                                                <?php $credit= 0; $all_pr = $data->paymentReceivesDetails; ?>
                                            
                                                @if(isset($all_pr))
                                                
                                                    @foreach($all_pr as $value)
                                                        
                                                        @if($start <= $value->payment_date && $value->payment_date <= $end)
            
                                                            <tr class="uk-text-upper">
                
                                                                <td  class="uk-text-left">{{date('d-m-Y', strtotime($value->payment_date))}}</td>
                                                                <td  class="uk-text-left">PR-{{$value->pr_number}}</td>
