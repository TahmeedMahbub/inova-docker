                    ...
                    <div id="invoice_preview hidden-print">
                        <div class="md-card-toolbar hidden-print">
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="md-card-dropdown" data-uk-dropdown="{pos:'bottom-right'}"
                                     aria-haspopup="true" aria-expanded="true"><a href="{{ route('account_report_total_transaction_index_data') }}">
                                         <i class="material-icons">account_balance_wallet</i><span>Total Account Transactions</span></a>
                                </div>
                                                        ...
                                                        <td class="uk-text-left">
                                                                ...
                                                                @elseif($JournalEntryData->jurnal_type == "expense")
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        Expense from {{ $JournalEntryData->expense->account->account_name }}
