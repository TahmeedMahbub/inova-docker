                    ...
                    <div id="invoice_preview">
                        <div class="md-card-toolbar">
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="md-card-dropdown" data-uk-dropdown="{pos:'bottom-right'}" aria-haspopup="true" aria-expanded="true"> <a href="#"></a>
                                        ...
                                        <div class="uk-width-large-2-2 uk-width-2-2">
                                            ...
                                            <div class="uk-width-large-2-2 uk-width-2-2">
                                                ...
                                                <select style="padding: 5px; border-top:none; border-left:none; border-right:none; border-bottom:1px solid lightgray"  id="report_account_id" name="report_account_id">
                                                    <option value="">Account</option>
                                                    @foreach($accounts as $accountsData)
                                                        <option @if(isset($find_account->id)) @if($accountsData->id == $find_account->id) selected @endif @endif style="z-index: 10002" value="{{$accountsData->id}}">{{$accountsData->account_name}}</option>
                                                    @endforeach
                                                </select>
                                               </div>
                        ...
                        <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                            ...
                            <div class="uk-grid" data-uk-grid-margin="">
                                ...
                                <div class="uk-width-small-5-5 uk-text-center">
                                    ...
                                    <p style="line-height: 5px;" class="heading_b uk-text-black">Account Transactions</p>
                                    <p style="line-height: 10px; margin-top: 10px;" class="uk-text-large">@if(isset($find_account->account_name)) {{ $find_account->account_name }} @else All Account @endif</p>
                                ...
                                <div class="uk-width-1-1">
                                    <table class="uk-table">
                                        ...
                                        <tr class="uk-text-upper">
                                            ...
                                            <th class="uk-text-center">CONTACT</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="uk-text-middle">
                                                <td class="uk-text-center"><strong>{{ date("d-m-Y", strtotime($start)) }}</strong></td>
                                                <td colspan="2" class="uk-text-center"><strong>Opening Balance</strong></td>
                                                <td class="uk-text-center"></td>
                                                <td class="uk-text-center"></td>

                                                @if($opening_balance >= 0)
                                                    <td class="uk-text-right">{{ abs($opening_balance) }}</td>
                                            ...
                                            @foreach($JournalEntry as $JournalEntryData)
                                                ...
                                                <tr class="uk-table-middle">
                                                    ...
                                                    <td class="uk-text-center">{{ date("d-m-Y",strtotime($JournalEntryData->assign_date)) }}</td>
                                                    <td class="uk-text-center">{{$JournalEntryData->account->account_name}}</td>
                                                    ...
                                                    <td class="uk-text-center">
                                                        ...
                                                        @elseif($JournalEntryData->jurnal_type == 'payment_made2')
                                                        {{ $JournalEntryData->paymentMade->account_id == 3 ? 'CP' : 'BP' }}-{{ \Carbon\Carbon::createFromFormat('Y-m-d', $JournalEntryData->paymentMade->payment_date)->year }}/{{str_pad($JournalEntryData->paymentMade->pm_number, 6, '0', STR_PAD_LEFT)}}
                                                        @elseif($JournalEntryData->jurnal_type == 'payment_made1')
                                            ...
                                            <tr>
                                                <td class="uk-text-right" colspan = "6"><strong>Balance</strong></td>
