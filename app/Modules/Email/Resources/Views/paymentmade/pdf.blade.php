    ...
    <div>
        ...
        <div style="font-size: 12px;text-align: center">
            <div >
                ...
                <p style="margin: 0;padding: 0">#{{ $payment_made->account_id == 3 ? 'CP' : 'BP' }}-{{ \Carbon\Carbon::createFromFormat('Y-m-d', $payment_made->payment_date)->year }}/{{ str_pad($payment_made->id, 6, '0', STR_PAD_LEFT) }}</p>
            </div>
        </div>
    </div>
</div>
